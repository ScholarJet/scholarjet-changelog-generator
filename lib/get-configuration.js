    ...
    return {
        ...
        jira: {
            ...
            api: {
                ...
                username: configurationOptions.jiraEmail,
                password: configurationOptions.jiraPassword,
            },
        ...
        transformData: function (data) {
            ...
            newData.tickets.approved = processTicketsForTemplateUsage(newData.tickets.approved);
            newData.tickets.all = processTicketsForTemplateUsage(newData.tickets.all);
            newData.commits.noTickets = newData.commits.noTickets.map(commit => updatePRInCommit(commit, GITHUB_URL));
